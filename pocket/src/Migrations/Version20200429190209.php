 ...
 */
final class Version20200429190209 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE pockets (id UUID NOT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, client_id VARCHAR(255) NOT NULL, network VARCHAR(255) NOT NULL, pocket_id UUID NOT NULL, invite_token_token VARCHAR(255) DEFAULT NULL, invite_token_expires TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
